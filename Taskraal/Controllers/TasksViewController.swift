...
class TasksViewController: UIViewController {
    ...
    @objc private func showAIAssistant() {
        // Commenting out for now until AIPrioritizationViewController is properly configured in the project
        // let aiVC = AIPrioritizationViewController()
        // let navController = UINavigationController(rootViewController: aiVC)
        // navController.modalPresentationStyle = .formSheet
        // present(navController, animated: true)
        
        // Show a placeholder alert instead
        let alert = UIAlertController(
            title: "AI Assistant",
            message: "AI Assistant feature is temporarily unavailable.",
